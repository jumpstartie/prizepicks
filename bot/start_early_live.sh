...
# Drop SOL: paper loss was a coin-flip SOL tip; NEAR/DOGE printed.
export EARLY_SERIES="${EARLY_SERIES:-KXBTC15M,KXETH15M,KXXRP15M,KXBNB15M,KXDOGE15M,KXNEAR15M}"
...
export EARLY_STAKE_FRAC="${EARLY_STAKE_FRAC:-0.10}"
export EARLY_STAKE_CAP="${EARLY_STAKE_CAP:-15}"
export EARLY_MAX_OPEN="${EARLY_MAX_OPEN:-2}"
export EARLY_POLL_SEC="${EARLY_POLL_SEC:-2}"
# FORCE LIVE: skip paper W/L gate. Day-stop + live streak disarm still apply.
export EARLY_FORCE_ARM="${EARLY_FORCE_ARM:-1}"
export EARLY_ARM_WINS="${EARLY_ARM_WINS:-0}"
export EARLY_ARM_MAX_LOSSES="${EARLY_ARM_MAX_LOSSES:-99}"
